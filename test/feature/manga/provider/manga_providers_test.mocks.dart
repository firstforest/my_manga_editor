...
import 'package:my_manga_editor/data/model/manga.dart' as _i4;
import 'package:my_manga_editor/data/repository/manga_repository.dart' as _i2;
...
class MockMangaRepository extends _i1.Mock implements _i2.MangaRepository {
  ...
  @override
  _i3.Future<_i6.Delta?> loadDelta(
    _i4.MangaId? mangaId,
    _i4.DeltaId? firestoreDeltaId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Stream<_i6.Delta?> getDeltaStream(
    _i4.MangaId? mangaId,
    _i4.DeltaId? firestoreDeltaId,
  ) =>
      (super.noSuchMethod(
