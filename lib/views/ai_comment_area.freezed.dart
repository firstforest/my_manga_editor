...
extension AiCommentPatterns on AiComment {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AiComment value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String text, DateTime createdAt, String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AiComment() when $default != null:
        return $default(_that.text, _that.createdAt, _that.errorMessage);
      case _:
        return orElse();
    }
  }
