...
| 作業対象 | 参照ドキュメント |
|---|---|
| リリース・バックアップ・ロールバック | [docs/release.md](docs/release.md) |
| **利用者から見て何かが変わる変更を入れたとき** | [CHANGELOG.md](CHANGELOG.md) の `## [Unreleased]` に利用者の言葉で追記する（[書き方](docs/release.md#リリースノートを書く)）|
