...
class $DbDeltasTable extends DbDeltas with TableInfo<$DbDeltasTable, DbDelta> {
  ...
  DbDelta map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DbDelta(
      ...
      delta: $DbDeltasTable.$converterdelta.fromSql(
...
class DbDelta extends DataClass implements Insertable<DbDelta> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['delta'] = Variable<String>(
        $DbDeltasTable.$converterdelta.toSql(delta),
      );
    }
    return map;
  }
  ...
  DbDeltasCompanion toCompanion(bool nullToAbsent) {
    return DbDeltasCompanion(id: Value(id), delta: Value(delta));
  }

  factory DbDelta.fromJson(
    ...
    return DbDelta(
      ...
      delta: $DbDeltasTable.$converterdelta.fromJson(
        serializer.fromJson<String>(json['delta']),
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'delta': serializer.toJson<String>(
        $DbDeltasTable.$converterdelta.toJson(delta),
      ),
    };
  }

  DbDelta copyWith({int? id, Delta? delta}) =>
      DbDelta(id: id ?? this.id, delta: delta ?? this.delta);
...
class DbDeltasCompanion extends UpdateCompanion<DbDelta> {
  ...
  DbDeltasCompanion copyWith({Value<int>? id, Value<Delta>? delta}) {
    return DbDeltasCompanion(id: id ?? this.id, delta: delta ?? this.delta);
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (delta.present) {
      map['delta'] = Variable<String>(
        $DbDeltasTable.$converterdelta.toSql(delta.value),
      );
    }
    return map;
  }
...
class $DbMangasTable extends DbMangas with TableInfo<$DbMangasTable, DbManga> {
  ...
  static const VerificationMeta _ideaMemoMeta = const VerificationMeta(
    'ideaMemo',
  );
  @override
  ...
  DbManga map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DbManga(
      ...
      startPage: $DbMangasTable.$converterstartPage.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}start_page'],
        )!,
      ),
      ideaMemo: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}idea_memo'],
      )!,
    );
  }
...
class DbManga extends DataClass implements Insertable<DbManga> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['name'] = Variable<String>(name);
    {
      map['start_page'] = Variable<int>(
        $DbMangasTable.$converterstartPage.toSql(startPage),
      );
    }
  ...
  factory DbManga.fromJson(
    ...
    return DbManga(
      ...
      startPage: $DbMangasTable.$converterstartPage.fromJson(
        serializer.fromJson<int>(json['startPage']),
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'startPage': serializer.toJson<int>(
        $DbMangasTable.$converterstartPage.toJson(startPage),
      ),
...
class $DbMangaPagesTable extends DbMangaPages
  ...
  static const VerificationMeta _memoDeltaMeta = const VerificationMeta(
    'memoDelta',
  );
  @override
  ...
  static const VerificationMeta _dialoguesDeltaMeta = const VerificationMeta(
    'dialoguesDelta',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<DbMangaPage> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  DbMangaPage map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DbMangaPage(
      ...
      memoDelta: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}memo_delta'],
      )!,
      stageDirectionDelta: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}stage_direction_delta'],
      )!,
      dialoguesDelta: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}dialogues_delta'],
      )!,
    );
  }
...
class DbMangaPage extends DataClass implements Insertable<DbMangaPage> {
  ...
  factory DbMangaPage.fromJson(
    ...
    return DbMangaPage(
      ...
      stageDirectionDelta: serializer.fromJson<int>(
        json['stageDirectionDelta'],
      ),
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('db_manga_pages', kind: UpdateKind.delete)],
    ),
  ]);
}

typedef $$DbDeltasTableCreateCompanionBuilder =
    DbDeltasCompanion Function({Value<int> id, required Delta delta});
typedef $$DbDeltasTableUpdateCompanionBuilder =
    DbDeltasCompanion Function({Value<int> id, Value<Delta> delta});
...
final class $$DbDeltasTableReferences
  ...
  static MultiTypedResultKey<$DbMangasTable, List<DbManga>> _dbMangasRefsTable(
    ...
    db.dbMangas,
    aliasName: $_aliasNameGenerator(db.dbDeltas.id, db.dbMangas.ideaMemo),
  );
  ...
  _memoDeltaTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dbMangaPages,
    aliasName: $_aliasNameGenerator(db.dbDeltas.id, db.dbMangaPages.memoDelta),
  );

  $$DbMangaPagesTableProcessedTableManager get memoDelta {
    final manager = $$DbMangaPagesTableTableManager(
      $_db,
      $_db.dbMangaPages,
  ...
  static MultiTypedResultKey<$DbMangaPagesTable, List<DbMangaPage>>
  _stageDirectionDeltaTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dbMangaPages,
    aliasName: $_aliasNameGenerator(
      db.dbDeltas.id,
      db.dbMangaPages.stageDirectionDelta,
    ),
  );
  ...
  $$DbMangaPagesTableProcessedTableManager get stageDirectionDelta {
    final manager = $$DbMangaPagesTableTableManager($_db, $_db.dbMangaPages)
        .filter(
          (f) => f.stageDirectionDelta.id.sqlEquals($_itemColumn<int>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _stageDirectionDeltaTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  static MultiTypedResultKey<$DbMangaPagesTable, List<DbMangaPage>>
  _dialoguesDeltaTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dbMangaPages,
    aliasName: $_aliasNameGenerator(
      db.dbDeltas.id,
      db.dbMangaPages.dialoguesDelta,
    ),
  );
...
class $$DbDeltasTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $DbDeltasTable,
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => DbDeltasCompanion(id: id, delta: delta),
          createCompanionCallback:
              ({Value<int> id = const Value.absent(), required Delta delta}) =>
                  DbDeltasCompanion.insert(id: id, delta: delta),
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$DbDeltasTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    return [
                      if (dbMangasRefs)
                        ...
                        >(
                          ...
                          referencedTable: $$DbDeltasTableReferences
                              ._dbMangasRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$DbDeltasTableReferences(
                                db,
                                table,
                                p0,
                              ).dbMangasRefs,
                      ...
                      if (stageDirectionDelta)
                        ...
                        >(
                          ...
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.stageDirectionDelta == item.id,
                              ),
                          typedResults: items,
                        ),
                      if (dialoguesDelta)
...
typedef $$DbDeltasTableProcessedTableManager =
...
final class $$DbMangasTableReferences
  ...
  $$DbDeltasTableProcessedTableManager get ideaMemo {
    ...
    final manager = $$DbDeltasTableTableManager(
      $_db,
      $_db.dbDeltas,
  ...
  _dbMangaPagesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dbMangaPages,
    aliasName: $_aliasNameGenerator(db.dbMangas.id, db.dbMangaPages.mangaId),
  );
          ...
          prefetchHooksCallback:
              ({ideaMemo = false, dbMangaPagesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (dbMangaPagesRefs) db.dbMangaPages,
                  ],
                  addJoins:
                      <
                          ...
                          state =
                              state.withJoin(
                                    ...
                                    referencedTable: $$DbMangasTableReferences
                                        ._ideaMemoTable(db),
                                    referencedColumn: $$DbMangasTableReferences
                                        ._ideaMemoTable(db)
                                        .id,
                                  )
                                  as T;
...
typedef $$DbMangasTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool ideaMemo, bool dbMangaPagesRefs})
    >;
typedef $$DbMangaPagesTableCreateCompanionBuilder =
    DbMangaPagesCompanion Function({
      Value<int> id,
      required int mangaId,
      required int pageIndex,
      required int memoDelta,
...
typedef $$DbMangaPagesTableUpdateCompanionBuilder =
    DbMangaPagesCompanion Function({
      Value<int> id,
      Value<int> mangaId,
      Value<int> pageIndex,
...
class $$DbMangaPagesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $DbMangaPagesTable,
...
typedef $$DbMangaPagesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DbMangaPagesTable,
      DbMangaPage,
